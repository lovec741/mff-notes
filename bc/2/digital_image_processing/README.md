...
#### Obsah
*Zápisky jsou zamýšleny, tak aby byly čteny souběžně s prezentacemi* - [Stránka předmětu](https://zoi.utia.cas.cz/index.php/teaching/lecture-courses/npgr002)
...
2. [Předzpracování (preprocessing)](2%20Předzpracování%20(preprocessing).md)
    - Prezentace: (v tomto pořadí)
        ...
        - 06+07-Image registration
3. [Analýza](3%20Analýza.md)
    - Prezentace: (v tomto pořadí)
        - 09-Recognition
        - 10-Classifiers (konec se nešel moc do detailu)
